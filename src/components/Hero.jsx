         ...
         <div className='body'>
          <div className='content'>
            <div className='space-y-5 hidden md:block'>                                                                     
              ...
              <p className='subtitle'> Sip the Spirit 
              <br /> of Summer</p>
            </div>
            <div className='view-cocktails'>
              <p className='subtitle'>Sip into perfection 
                   with handcrafted Cocktails, timeless Classics
                         and expert Mixology tips
                  to elevate every pour.</p>
